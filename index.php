...
// seleccionar registros de deportes
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#portfolio">Deportes</a></li>
        ...
        <section class="page-section" id="services">
            ...
            <?php foreach($lista_servicios as $registros){?>
                    <div class="col-md-4">
                            <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/servicios/<?php echo $registros['imagen'];?>" alt="..." /></div>
                        </span>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Deportes</h2>
                    <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3>
                </div>
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="portfolio-item">
                                <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1<?php echo $registros["ID"];?>">
                                    ...
                                    <img class="img-fluid" src="assets/img/deportes/<?php echo $registros["imagen"];?>" alt="..." />
                                </a>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <img class="img-fluid d-block mx-auto" src="assets/img/deportes/<?php echo $registros["imagen"];?>" alt="..." />
                                    <p><?php echo $registros["descripcion"];?></p>
                                    <ul class="list-inline">
                                        <li>
                                            <strong>Entrenador:</strong>
                                            <?php echo $registros["entrenador"];?>
                                        </li>
                                        <li>
                                            <strong>Horario:</strong>
                                            <?php echo $registros["horario"];?>
                                        </li> 
                                        <li>
                                            <strong>URL:</strong>
        ...
        <section class="page-section" id="about">
            <div class="container">
                ...
                <ul class="timeline">
                    ...
                    <?php
                    $contador=1;
                     foreach($lista_sobrenosotros as $registros){ 
                    ...
                    <?php foreach($lista_equipo as $registros){  ?>
                        <div class="col-lg-4">
                            <div class="team-member">
                                ...
                                <a class="btn btn-dark btn-social mx-2" href="<?php echo $registros["instagram"];?>" aria-label="Parveen Anand instagram Profile"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                    <?php } ?> 
